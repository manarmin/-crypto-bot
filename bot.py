...
# توکن ربات تست جدید (در صورت عدم وجود متغیر در گیت‌هاب)
TEST_BOT_TOKEN = '8778525679:AAF0DG2sZLkuega7VJpOg5KQdpteAoA66NU'

# خواندن هوشمند توکن: در گیت‌هاب توکن تست و در پایتون‌انی‌ویر توکن اصلی استفاده می‌شود
TELEGRAM_TOKEN = os.environ.get('TELEGRAM_BOT_TOKEN', MAIN_BOT_TOKEN)
