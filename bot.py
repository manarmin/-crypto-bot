...
TOP_LIMIT = 250  # تنظیم ظرفیت دقیق روی ۲۵۰ ارز برتر
...
STATIC_TOP_250 = [
    ...
    'GRTUSDT', 'FLOKIUSDT', 'THETAUSDT', 'FTMUSDT', 'BONKUSDT', 'RUNEUSDT', 'JUPUSDT',
    'GALAUSDT', 'STRKUSDT', 'ENAUSDT', 'FLOWUSDT', 'PYTHUSDT', 'EGLDUSDT', 'DYDXUSDT',
    'AXSUSDT', 'SANDUSDT', 'MANAUSDT', 'ENSUSDT', 'CRVUSDT', 'ORDIUSDT', 'ALGOUSDT',
    'CHZUSDT', 'NEOUSDT', 'EOSUSDT', 'KSMUSDT', 'LDOUSDT', 'QNTUSDT'
]
...
def get_top_market_cap_symbols():
    """استراتژی چندلایه هوشمند برای استخراج ۲۵۰ ارز برتر"""
    ...
    # --- لایه ۲ (پشتیبان): دریافت ۲۵۰ ارز پرحجم ۲۴ ساعته بایننس ---
