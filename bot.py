...
# تنظیم انکودینگ UTF-8 برای رفع کامل خطای ascii codec در ارسال تلگرام
...
def main():
  print('شروع آنالیز ۱۰۰ ارز برتر...')
  symbols = get_top_100_market_cap_symbols()
  print(f'تعداد {len(symbols)} ارز یافت شد.')
  ...
  gc.collect()
  print('اسکن کاملاً انجام شد و سیگنال‌ها (در صورت وجود) ارسال گردیدند.')
