...
TOP_LIMIT = 100
ALWAYS_INCLUDE = ['BTCUSDT', 'ETHUSDT', 'SOLUSDT']
...
def get_top_100_market_cap_symbols():
  """دریافت ۱۰۰ ارز برتر بازار بر اساس ترکیب حجم ۲۴ ساعته صرافی و Market Cap"""
  ...
  # ترکیب و اولویت‌بندی ارزهای پرحجم و دارای Market Cap بالا
  ranked_symbols = []
...
def main():
  print('شروع اسکن ترکیبی (Top Volume 24h + CoinGecko)...')
  symbols = get_top_100_market_cap_symbols()
  print(f'تعداد {len(symbols)} ارز پرحجم و برتر یافت شد.')
